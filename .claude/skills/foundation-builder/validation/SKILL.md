...
├── Capacity: Full-time founders (Bella + Lisa), $130/mo AI tools
...
```json
{
  ...
  "mvp_spec": {
    "features": ["AI skin analysis", "Product recommendations", "Purchase tracking"],
    "non_features": ["Social sharing", "Community", "Marketplace"],
    "success_metrics": {
      "activation": 40,
      "day_7_retention": 30,
      "nps": 30
