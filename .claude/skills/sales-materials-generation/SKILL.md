---
name: sales-materials-generation
description: Generate sales collateral (pitch deck, one-pager, call scripts, email templates) from Canvas, narrative, and ICP with problem-first ordering and stage-appropriate messaging. Use when you need to create sales materials for a product.
