---
name: go-to-market
description: Generate or update go-to-market strategy in strategy/canvas/15.go-to-market.md. Use when: defining GTM motion, selecting channels, planning launch, or updating channel priorities based on data. Outputs the single GTM source of truth that all marketing and sales skills read. Requires Canvas files (segments, problem, UVP, solution).
