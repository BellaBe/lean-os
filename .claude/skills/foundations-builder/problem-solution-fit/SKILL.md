...
description: Problem validation and solution design agent for AI-first startups. Use this agent when discovering and validating customer problems, generating solution hypotheses, analyzing alternatives, defining MVP scope, or developing innovation strategy. Merges problem framing, alternative analysis, solution building, and innovation strategy into unified problem-solution fit analysis.
---
