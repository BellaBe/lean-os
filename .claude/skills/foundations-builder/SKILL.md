...
**Status:** 📝 DRAFT
**Hypothesis:** {Your product category} TAM is ${X}B
**Confidence:** 40%
**Source:** market-intelligence agent, industry reports
...
**User Request**: "Help me understand the competitive landscape for {your product category}"
...
**User Request**: "How should we price our {product/service}?"
