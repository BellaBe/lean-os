...
**Input**: Canvas for GlamYouUp (AI fitting room for fashion e-commerce)

**Process**:
1. Read `segments.md` → "Online fashion retailers with high return rates"
2. Convert to observable:
   - Platform: Shopify, WooCommerce
   - Industry: Apparel retail (NAICS 448)
   - Problem signal: Return rate mentioned on FAQ page
...
4. Map to tools:
   - BuiltWith: "Shopify stores in Apparel category"
   - SimilarWeb: "10K-100K monthly visitors"
   - Manual: Check FAQ for "returns" or "sizing"
