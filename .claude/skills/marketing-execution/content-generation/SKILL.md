...
description: Generate content drafts adapted to GTM motion. Subskill of marketing-execution — receives mode parameter, does not detect motion. Use when creating blog posts, case studies, social posts, sales collateral, or app store copy. Requires brand-voice.md and positioning.md.
