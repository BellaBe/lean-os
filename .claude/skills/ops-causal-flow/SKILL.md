...
### Engineering Threads
**Path:** `/mnt/project/Causal_Flow_Skill/reference/engineering-threads.md`
...
**Example:**
```
User: "{Customer} wants enterprise SDK, $400K budget"

1. Type: sales
2. Read /mnt/project/Causal_Flow_Skill/reference/sales-threads.md
3. Create threads/sales/{customer}-enterprise/
...
- `/mnt/project/Causal_Flow_Skill/reference/engineering-threads.md`
