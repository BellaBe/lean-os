...
- Pricing tier (from Canvas pricing section)
  - Base price
  - Add-ons (e.g., analytics, white-label)
...
- Duration: 30-60 min
- Attendees: Lead decision-makers, Bella
...
**Attendees:** Lead decision-makers (economic buyer, legal), Bella
...
**Note:** Legal review workflow to be defined later. For now, Bella handles directly.
