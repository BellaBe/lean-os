...
❌ "Customer wants white-label, so we should build it"
✓ "Customer requested white-label"
...
❌ "Customers want white-label AND our conversion rate dropped AND competitor launched X"
